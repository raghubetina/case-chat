...
| [0004](0004-publish-an-atomic-configuration.md) | Publish an atomic configuration snapshot | Accepted | Lifecycle and top-level case editing verified; child authoring concurrency planned |
