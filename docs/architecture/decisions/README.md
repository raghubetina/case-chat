...
| [0003](0003-use-first-party-ai-sdks.md) | Integrate providers through first-party SDKs | Accepted | Provider adapters verified; orchestration planned |
...
| [0005](0005-compose-stakeholder-prompts-in-the-app.md) | Compose stakeholder prompts in the app | Accepted | Author input and composition verified; adapters available; orchestration planned |
