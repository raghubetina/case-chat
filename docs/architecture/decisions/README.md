...
| [0005](0005-compose-stakeholder-prompts-in-the-app.md) | Compose stakeholder prompts in the app | Accepted | Author input and provider-neutral composition verified; provider integration planned |
