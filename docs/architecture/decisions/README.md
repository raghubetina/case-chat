...
| [0003](0003-use-first-party-ai-sdks.md) | Integrate providers through first-party SDKs | Accepted | Adapters and persisted text generation verified; product request integration planned |
| [0004](0004-publish-an-atomic-configuration.md) | Publish an atomic configuration snapshot | Accepted | Author publication and lifecycle verified; remaining child concurrency planned |
| [0005](0005-compose-stakeholder-prompts-in-the-app.md) | Compose stakeholder prompts in the app | Accepted | Author input, composition, and provider delivery verified; tools planned |
